...
# python train.py --gpu-id 3 \
# --train-cover-dir /data/gbli/works/steganalysis/data/train/cover --val-cover-dir /data/gbli/works/steganalysis/data/test/cover \
# --train-stego-dir /data/gbli/works/steganalysis/data/train/stego --val-stego-dir /data/gbli/works/steganalysis/data/test/stego \
# --model kenet --ckpt-dir ./checkpoint/odih1


train_cover_dir="/data/gbli/works/steganalysis/data/train/cover"
val_cover_dir="/data/gbli/works/steganalysis/data/test/cover"
train_stego_dir="/data/gbli/works/steganalysis/data/train/stego"
val_stego_dir="/data/gbli/works/steganalysis/data/test/stego"
ckpt_dir="./checkpoint/odih"
gpu_id=0
fintune='/data/gbli/works/steganalysis/SiaStegNet-master/checkpoint/odih/model_best.pth.tar'
...
def parse_args():
    ...
    parser.add_argument('--epoch', dest='epoch', type=int, default=100)  # default=1000
    ...
    parser.add_argument('--gpu-id', dest='gpu_id', type=int, default=2)
