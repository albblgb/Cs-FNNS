...
if __name__ == "__main__":
    ...
    train_loader = load_train_data(opt.cover_path, opt.stego_path, opt.train_size,)
    valid_loader = load_test_data(opt.valid_cover_path, opt.valid_stego_path, opt.val_size,)
    ...
    for epoch in range(START_EPOCH, opt.num_epochs + 1):
        ...
        for i, train_batch in enumerate(stream):
        ...
        if epoch % 2 == 0:
            ...
            with torch.no_grad():
                ...
                for i, val_batch in enumerate(stream):
