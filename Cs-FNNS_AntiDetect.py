...
logger_name = 'Cs-FNNS_anti-Staganalysis'
image_save_dirs = os.path.join('results', 'Cs-FNNS_anti-Staganalysis', secret_dataset)
...
for i in range(len(secret_image_path_list)):  
    ...
    # img_hist(secret_resi_draw, os.path.join(hist_save_dir +  str(i) + '_BP.pdf'))
    ...
    # secret_resi_draw = (secret - secret_rev).clone().view(-1).detach().cpu().numpy()*255
    # img_hist(secret_resi_draw, os.path.join(hist_save_dir +  str(i) + '_AP.png'))
